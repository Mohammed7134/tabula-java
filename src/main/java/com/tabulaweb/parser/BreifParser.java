...
public class BreifParser {

    public static List<BreifItem> parseBreif(InputStream pdfInputStream) throws Exception {
        List<BreifItem> breifItems = new ArrayList<>();
                ...
                for (Table table : tables) {
                    for (List<RectangularTextContainer> row : table.getRows()) {
                        ...
                        try {
                            ...
                            BreifItem item = new BreifItem(code, name, currentStock, totalOut, difference, expiry);
                            breifItems.add(item);
